                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4" style="margin-top:130px;">
                            <img src="{{ asset('avatar/'.Auth::user()->avatar) }}" style="width:300px; height:300px;" class="rounded-circle">
                        </div>
                        <div class="col-lg-8 d-flex align-items-center">
                            <div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <span class="badge deep-orange pt-2 pb-2 pr-3 pl-3 rounded-pill z-depth-0" style="font-size:13px;">{{ Auth::user()->email }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <span>{{ ucwords(strtolower($data->province)) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
